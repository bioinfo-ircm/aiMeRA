...
#'@description This function computes the standard deviation and average values of a data set. Namely, if n replicates were generated,
...
#'@return A list containing two matrices, the standard deviations and mean values for each variable in x.
#'@export
#'@examples
